...
public class WTPdfViewerWidget extends HTML {
  private final String pdfWorkerFile;
  ...
  public WTPdfViewerWidget (String pdfWorkerFile) {
    this.pdfWorkerFile = pdfWorkerFile;
  ...
  public native void startWebViewerLoad (WTPdfViewerWidget instance)
    /*-{
      var configuration = {
        ...
        defaultUrl: '',
        workerSrc: this.@WTPdfViewerWidget::resolvePdfWorker()()
      };
  ...
  public String resolvePdfWorker () {
    return this.pdfWorkerFile;
  }
